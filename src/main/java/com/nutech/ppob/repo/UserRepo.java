...
public class UserRepo {
    ...
    public void insertUser(String email, String passwordHash, String firstName, String lastName) throws DuplicateKeyException {
        jdbc.update("""
    ...
    public ProfileResponse getProfileByEmail(String email) {
        try {
            return jdbc.queryForObject("""
                SELECT first_name, last_name, email, COALESCE(profile_image_url,'') AS profile_image_url
    ...
    public int updateProfileImage(String email, String imageUrl) {
        return jdbc.update("""
            UPDATE users SET profile_image_url = ?, updated_at = CURRENT_TIMESTAMP
            WHERE email = ?
        """, imageUrl, email);
    }
}
